...
urlpatterns = [
    ...
    path("frameworks/table-body/", views.FrameworkTableBodyView.as_view(), name="framework-table-body"),
    ...
    path("mappings/table-body/", views.MappingTableBodyView.as_view(), name="mapping-table-body"),
    ...
    path("action-plans/table-body/", views.ActionPlanTableBodyView.as_view(), name="action-plan-table-body"),
