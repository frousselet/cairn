"""Data migration: add Contract permissions and assign them to system groups.
...
NEW_PERMISSIONS = [
    {
        "codename": f"assets.contract.{action}",
        "name": f"Assets - Contracts - {_ACTION_LABELS[action]}",
        "module": "assets",
        "feature": "contract",
        "action": action,
    }
