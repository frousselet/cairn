...
class GeneralDashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Authoritative (in-force) scopes : read the governance code set off the
        # scope lifecycle rather than hardcoding the step.
        ctx["active_scopes"] = reportable(scopes).select_related("parent_scope")[:5]
        ...
        def _place(entry):
            ...
            item = {
                ...
                "row_tracks": widget.row_tracks(size),
                "w": widget.width(size),
        ...
        ctx["indicator_widget_template"] = {
            ...
            "row_tracks": ind_widget.row_tracks(ind_widget.default_size),
        ...
        ctx["section_widget_template"] = {
            ...
            "row_tracks": sec_widget.row_tracks(sec_widget.default_size),
