...
- **Steering** : real-time dashboard (risk matrices and a current-to-residual risk treatment flow chart), a unified To do / Doing / Done "Tasks" board aggregating action plans, treatment actions, audits and risk assessments, KPI indicators, ISO 27001 management reviews, and PDF/DOCX/PPTX report generation (SoA, audit report, risk register, meeting minutes)
